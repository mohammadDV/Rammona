...
export const resolveNuxtI18nOptions = async (context) => {
 ...
 const vueI18nConfigLoader = async (context, loader) => {
  ...
  const vueI18n = await vueI18nConfigLoader(context, (() => import("\u0000@nuxtjs/i18n/__config__?target=../i18n.config.ts&c=f02192b1" /* webpackChunkName: "__i18n_config_ts_f02192b1" */)))
