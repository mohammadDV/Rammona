globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/mohammaddv/Downloads/Rammona/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///Users/mohammaddv/Downloads/Rammona/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, readBody, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery } from 'file:///Users/mohammaddv/Downloads/Rammona/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///Users/mohammaddv/Downloads/Rammona/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///Users/mohammaddv/Downloads/Rammona/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Users/mohammaddv/Downloads/Rammona/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/mohammaddv/Downloads/Rammona/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/mohammaddv/Downloads/Rammona/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/mohammaddv/Downloads/Rammona/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/mohammaddv/Downloads/Rammona/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/mohammaddv/Downloads/Rammona/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/mohammaddv/Downloads/Rammona/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file:///Users/mohammaddv/Downloads/Rammona/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/mohammaddv/Downloads/Rammona/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/mohammaddv/Downloads/Rammona/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/mohammaddv/Downloads/Rammona/node_modules/radix3/dist/index.mjs';
import { generateJSON } from 'file:///Users/mohammaddv/Downloads/Rammona/node_modules/@intlify/bundle-utils/index.mjs';
...
const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false}}},"public":{"cookies":{"theme":"theme","locale":"language","token":"token","refreshToken":"refresh_token","profile":"profile","permission":"permission"},"baseUrl":"","token":{"maxAge":36000,"refreshMaxAge":604800},"i18n":{"experimental":{"jsTsFormatResource":false},"baseUrl":""}},"i18n":{"precompile":{"strictMessage":true,"escapeHtml":false}}};
...
const serverAssets = [{"baseName":"server","dir":"/Users/mohammaddv/Downloads/Rammona/server/assets"}];
...
storage.mount('i18n', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/mohammaddv/Downloads/Rammona/.nuxt/i18n","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mohammaddv/Downloads/Rammona","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mohammaddv/Downloads/Rammona/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mohammaddv/Downloads/Rammona/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mohammaddv/Downloads/Rammona/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _hh7KYs = defineEventHandler(async (event) => {
...
const _lazy_UEUyOY = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_UEUyOY, lazy: true, middleware: false, method: undefined },
  { route: '/__i18n__/precompile', handler: _hh7KYs, lazy: false, middleware: false, method: "post" },
  { route: '/**', handler: _lazy_UEUyOY, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/Users/mohammaddv/Downloads/Rammona/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<title>irisk</title>\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<link rel=\"icon\" type=\"image/x-icon\" href=\"/icon.png\">","bodyTags":"","bodyTagsOpen":"","htmlAttrs":" lang=\"fa\"","bodyAttrs":""};
